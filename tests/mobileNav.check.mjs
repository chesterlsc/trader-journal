...
// The dock carries the four daily destinations. Timing replaces the old
// terminal/reflection split so Session Intelligence is one tap away on phone.
assert.deepEqual(
  [...dockTargets].sort(),
  ["calendar", "dashboard", "journal", "session-intelligence"],
